<html lang="en" >
   ...
   <head>
      ...
      <link href="{{ asset('css/pages/login/classic/login-5.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>

      <!--end::Page Custom Styles-->

      <!--begin::Global Theme Styles(used by all pages)-->

      <link href="{{ asset('media/plugins/global/plugins.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
            ...
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{asset('media/bg/bg-2.jpg') }});">
               ...
               <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                  ...
                  <div class="d-flex flex-center mb-15">
                     ...
                     <img src="{{ asset('media/logos/lambada.png') }}" class="max-h-75px" alt=""/>
                  ...
                  <div class="login-signin">
                     ...
                     <div class="mb-20">
                        ...
                        <h3 class="opacity-40 font-weight-normal">Welcome. Please login.</h3>
