...
<div class="card card-custom">
        	<div class="card-header bg-primary d-flex">
                ...
                <div class="card-toolbar" >
                  <div id="tool-pertama">
                    <a onclick="AddData()" class="btn btn-sm btn-white">
                        <i class="fa fa-save"></i> Tambah Data
                    </a>
                  </div>
                  <div id="tool-kedua">
                    <a id="savedata" class="btn btn-sm btn-white">
                        <i class="fa fa-save"></i> Save
                    </a>
                    <a onclick="CancelData()" class="btn btn-sm btn-white">
                        <i class="fa fa-reply"></i> Cancel
                    </a>
                  </div>
                  <div id="tool-ketiga">
                    <a id="back" class="btn btn-sm btn-success" onclick="CancelData()" >
