	...
	{{-- Header --}}
		    @if ($noid == 'null')
				...
				<form method="POST" action="{{ url('/login/loginPost') }}">
						...
						<div class="form-group row">
							<input placeholder="Password" id="password" type="password" class="form-control form-control-solid h-auto py-5 px-6 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
						...
						<div class="form-group row mb-0">
								<div class="col-md-12">
										...
										<button type="submit" class="btn btn-primary font-weight-bold px-12 py-4 my-3">
												{{ __('Login') }}
										</button>
								</div>
						</div>
		...
		{{-- Content --}}
			...
			{{-- Header --}}
					...
					<i class="symbol-badge bg-success"></i>
							...
							<div class="d-flex flex-column">
									<a href="{{ url('/99999999') }}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
						{{ $myusername }}
					</a>
									...
									{{ Metronic::getSVG("media/svg/icons/Communication/Mail-notification.svg", "svg-icon-lg svg-icon-primary") }}
															...
															<a href="{{ url('/login/logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
													</span>
											</a>
									</div>
							</div>
			...
			<div class="navi navi-spacer-x-0 p-0">
					{{-- Item --}}
					<a href="{{ Url('/99999999') }}" class="navi-item">
							<div class="navi-link">
