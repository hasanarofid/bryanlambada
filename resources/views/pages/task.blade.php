<html lang="en" >
   ...
   <body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading"  >
                                       ...
                                       <div class="card card-custom card-stretch" id="kt_todo_list">
                                          ...
                                          <div class="card-header align-items-center flex-wrap py-6 border-0 h-auto">
                                             ...
                                             <div class="d-flex align-items-center my-2">
                                                ...
                                                <span class="btn btn-light-success btn-sm text-uppercase font-weight-bolder" data-toggle="tooltip" title="Previose page">
                                                New Task
                                                </span>
                                             </div>
                                             <!--end::Actions-->
                                                ...
                                                <div class="list list-hover min-w-500px" data-inbox="list">
                                                   ...
                                                   <div class="d-flex align-items-start list-item card-spacer-x py-4" data-inbox="message">
                                                      ...
                                                      <div class="d-flex align-items-center justify-content-end flex-wrap" data-toggle="view">
                                                         ...
                                                         <!--begin::User Photo-->
                                                         <span class="symbol symbol-30 ml-3">
                                                         <span class="symbol-label" style="background-image: url({{asset('media/users/100_2.jpg') }});"></span>
                                                         </span>
                                                         <!--end::User Photo-->
                                                      </div>
                                                      <!--end::Details-->
                                                   ...
                                                   <div class="d-flex align-items-start list-item card-spacer-x py-4" data-inbox="message">
                                                      ...
                                                      <div class="d-flex align-items-center justify-content-end flex-wrap" data-toggle="view">
                                                         ...
                                                         <!--begin::User Photo-->
                                                         <span class="symbol symbol-30 ml-3">
                                                         <span class="symbol-label" style="background-image: url({{asset('media/users/100_4.jpg') }});"></span>
                                                         </span>
                                                         <!--end::User Photo-->
                                                      </div>
                                                      <!--end::Details-->
                                                   ...
                                                   <div class="d-flex align-items-start list-item card-spacer-x py-4" data-inbox="message">
                                                      ...
                                                      <div class="d-flex align-items-center justify-content-end flex-wrap" data-toggle="view">
                                                         ...
                                                         <!--begin::User Photo-->
                                                         <span class="symbol symbol-30 ml-3">
                                                         <span class="symbol-label" style="background-image: url({{asset('media/users/100_12.jpg') }});"></span>
                                                         </span>
                                                         <!--end::User Photo-->
                                                      </div>
                                                      <!--end::Details-->
                                                   ...
                                                   <div class="d-flex align-items-start list-item card-spacer-x py-4" data-inbox="message">
                                                      ...
                                                      <div class="d-flex align-items-center justify-content-end flex-wrap" data-toggle="view">
                                                         ...
                                                         <!--begin::User Photo-->
                                                         <span class="symbol symbol-30 ml-3">
                                                         <span class="symbol-label" style="background-image: url({{asset('media/users/100_6.jpg') }});"></span>
                                                         </span>
                                                         <!--end::User Photo-->
                                                      </div>
                                                      <!--end::Details-->
                                                   ...
                                                   <div class="d-flex align-items-start list-item card-spacer-x py-4" data-inbox="message">
                                                      ...
                                                      <div class="d-flex align-items-center justify-content-end flex-wrap" data-toggle="view">
                                                         ...
                                                         <!--begin::User Photo-->
                                                         <span class="symbol symbol-30 ml-3">
                                                         <span class="symbol-label" style="background-image: url({{asset('media/users/100_8.jpg') }});"></span>
                                                         </span>
                                                         <!--end::User Photo-->
                                                      </div>
                                                      <!--end::Details-->
                                                   ...
                                                   <div class="d-flex align-items-start list-item card-spacer-x py-4" data-inbox="message">
                                                      ...
                                                      <div class="d-flex align-items-center justify-content-end flex-wrap" data-toggle="view">
                                                         ...
                                                         <!--begin::User Photo-->
                                                         <span class="symbol symbol-30 ml-3">
                                                         <span class="symbol-label" style="background-image: url({{asset('media/users/100_9.jpg') }});"></span>
                                                         </span>
                                                         <!--end::User Photo-->
                                                      </div>
                                                      <!--end::Details-->
                                       ...
                                       <div class="card card-custom card-stretch" id="kt_todo_view">
                                          ...
                                          <div class="card-header align-items-center flex-wrap justify-content-between border-0 py-6 h-auto">
                                             ...
                                             <div class="d-flex align-items-center my-2">
                                                <div class="d-flex align-items-center">
                                                   <div class="symbol symbol-35 mr-3">
                                                      <div class="symbol-label" style="background-image: url({{asset('media/users/100_12.jpg') }});"></div>
                                                   </div>
                                                   <a href="#" class="text-dark-75 font-size-lg text-hover-primary font-weight-bolder">
                                                   Dave Stone
                                                   </a>
                                                </div>
                                             </div>
                                             ...
                                             <div class="d-flex align-items-center justify-content-end text-right my-2">
                                                ...
                                                <span class="btn btn-light-danger btn-sm text-uppercase font-weight-bolder mr-2" data-toggle="tooltip" title="Change due date">
                                                May 5
                                                </span>
                                                <span class="btn btn-light-success btn-sm text-uppercase font-weight-bolder" data-toggle="tooltip" title="Mark as complete">
                                                Complete
                                                </span>
                                             </div>
                                             <!--end::Right-->
                                             ...
                                             <div class="d-flex align-items-center justify-content-between flex-wrap card-spacer-x py-3">
                                                ...
                                                <div class="d-flex flex-column mr-2 py-2">
                                                   ...
                                                   <div class="d-flex align-items-center py-1">
                                                      ...
                                                      <span class="fa fa-genderless text-danger icon-md mr-2"></span> In progress
                                                      </a>
                                                      <a href="#" class="d-flex align-items-center text-muted text-hover-primary">
                                                      <span class="fa fa-genderless text-success icon-md mr-2"></span> Urgent
                                                      </a>
                                                   </div>
                                                </div>
                                                <!--end::Title-->
                                             ...
                                             <div class="mb-3">
                                                ...
                                                <div class="cursor-pointer shadow-xs toggle-off" data-inbox="message">
                                                   ...
                                                   <div class="d-flex align-items-start card-spacer-x py-4">
                                                      <!--begin::User Photo-->
                                                      <span class="symbol symbol-35 mr-3 mt-1">
                                                      <span class="symbol-label" style="background-image: url({{asset('media/users/100_10.jpg') }});"></span>
                                                      </span>
                                                      <!--end::User Photo-->
                                                      <!--begin::User Details-->
                                                      <div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
                                                         ...
                                                         <div class="d-flex flex-column">
                                                            ...
                                                            <div class="text-muted font-weight-bold toggle-on-item" data-inbox="toggle">
                                                               Compelleing title, your reader won't even get to the first
                                                            </div>
                                                         </div>
                                                      </div>
                                                      <div class="d-flex align-items-center">
      ...
      <script src="{{ asset('js/pages/custom/todo/todo.js?v=7.0.6') }}"></script>
      <!--end::Page Scripts-->
   </body>
   <!--end::Body-->
</html>
