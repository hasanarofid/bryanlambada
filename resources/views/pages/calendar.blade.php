<html lang="en" >
   <!--begin::Head-->
	 <head>
      ...
      <link href="{{ asset('plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css"/>
   ...
   <body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading"  >
      ...
      <script src="{{ asset('js/pages/features/calendar/basic.js?v=7.0.6') }}"></script>
      <!--end::Page Scripts-->
   </body>
   <!--end::Body-->
</html>
