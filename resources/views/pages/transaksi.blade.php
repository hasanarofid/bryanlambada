<html lang="en" >
   ...
   <head>
      <base href="../../../">
      <meta charset="utf-8"/>
      <title>Metronic | Transaksi</title>
   ...
   <body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading"  >
                        ...
                        <div class="card card-custom">
                           <div class="card-header flex-wrap py-5">
                              <div class="card-title">
                                 <h3 class="card-label">
                                    Transaksi
                                    <div class="text-muted pt-2 font-size-sm">multiple controls transaction</div>
                                 </h3>
                              </div>
                           ...
                           <div class="card-body">
                              <!--begin: Datatable-->
                              <table class="table table-responsive table-head-custom table-checkable" id="kt_datatable" >
                                 <thead>
                                    <tr>
                                       <th>Record ID</th>
                                       <th>Order ID</th>
      ...
      <script src="{{ asset('plugins/custom/datatables/datatables.bundle.js?v=7.0.6') }}"></script>
      <!--end::Page Vendors-->
      <!--begin::Page Scripts(used by this page)-->
      <script src="{{ asset('js/pages/crud/datatables/advanced/multiple-controls.js?v=7.0.6') }}"></script>
      <!--end::Page Scripts-->
   </body>
   <!--end::Body-->
</html>
